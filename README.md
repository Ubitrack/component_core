component_core
==============
This is the Ubitrack component_core submodule.

Description
----------
The component_core contains selected components.
...
## Upload
    ...
    $ conan upload -r ubitrack ubitrack_component_core/1.3.0@ubitrack/stable
